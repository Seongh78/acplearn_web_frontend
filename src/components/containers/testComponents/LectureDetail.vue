                                            ...
                                            <table class="ui table selectable single line" style="border:none;">
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="center aligned singleLineTd">시간</th>
                                                        <th class="singleLineTd">주제</th>
                                                        <th class="center aligned singleLineTd">활동내역</th>
                                                    </tr>
                                                </thead>
                                                <tbody class="borderTop" v-for="(module, mid)  in  timetable.modules">
                                                    <tr
                                                        class="cursorPointer"

                                                        @click="modal.lectureComments=true">
                                                        ...
                                                        <td class="center aligned singleLineTd">{{ module.lm_startTime }} ~ {{ module.lm_endTime }}</td>
                                                        <td class="singleLineTd">{{ module.lm_title }}</td>
                                                        <td class="center aligned singleLineTd">12건</td>
